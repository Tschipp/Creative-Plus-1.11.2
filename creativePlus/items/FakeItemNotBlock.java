...
public class FakeItemNotBlock extends Item
{
	public final Block block;


	public FakeItemNotBlock(Block block)
	{
	...
	public void getSubItems(Item itemIn, CreativeTabs tab, NonNullList<ItemStack> subItems)
	{
		...
		if(this.block instanceof BlockOldLog) {

			for(int i = 12; i < 16; i++) {
				subItems.add(new ItemStack(itemIn, 1, i));
			}
		}
		if(this.block instanceof BlockNewLog) {
	...
	{
		if(this.block instanceof BlockTNT) {
			tooltip.add("Explodes when broken");
		}
